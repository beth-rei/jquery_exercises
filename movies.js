...
$(function () {
    //when you click the delete button, remove the closet parent tr
    ...
    // when the delete button is clicked, remove the closet parent tr and remove from the array of the movies
